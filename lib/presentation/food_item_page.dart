          ...
          Padding(
            ...
            child: Text(
              ...
              style: Theme.of(context)
                  .textTheme
                  .headline4
                  .copyWith(fontWeight: FontWeight.w800, fontSize: 27.0),
            ),
          ),
          Padding(
            padding: const EdgeInsets.only(left: 16.0),
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            ...
                            style: Theme.of(context)
                                .textTheme
                                .bodyText2
                                .copyWith(color: Color(0xFFFE7D6A)),
                          ),
                          IconButton(
                            iconSize: 17.0,
          ...
          child: Row(
            children: [
              ...
              Column(
                ...
                children: [
                  Text(foodName, style: Theme.of(context).textTheme.bodyText2),
                  Text(
                    '\$$price',
                    style: Theme.of(context).textTheme.bodyText1.copyWith(
                        fontWeight: FontWeight.w600, color: Color(0xFFF68D7F)),
                  ),
                ],
              )
            ],
